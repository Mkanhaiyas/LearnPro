...
const Section = ({
  ...
  section: /* eslint-disable-line @typescript-eslint/no-explicit-any */ any;
  index: number;
  sectionProgress: /* eslint-disable-line @typescript-eslint/no-explicit-any */ any;
  chapterId: string;
  courseId: string;
  ...
  const completedChapters =
    sectionProgress?.chapters.filter(
      (c: /* eslint-disable-line @typescript-eslint/no-explicit-any */ any) =>
        c.completed
    ).length || 0;
      ...
      <div className="chapters-sidebar__progress">
        <div className="chapters-sidebar__progress-bars">
          {section.chapters.map(
            (
              chapter: /* eslint-disable-line @typescript-eslint/no-explicit-any */ any
            ) => {
